import{_ as t,X as p,Y as e,Z as n,a1 as o,$ as c,a2 as s,C as l}from"./framework-b6ea3384.js";const i={},u=s(`<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><h3 id="安装-node" tabindex="-1"><a class="header-anchor" href="#安装-node" aria-hidden="true">#</a> 安装 node</h3><h3 id="安装-nrm" tabindex="-1"><a class="header-anchor" href="#安装-nrm" aria-hidden="true">#</a> 安装 nrm</h3><p>nrm 可以指定下载的镜像源</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
