import{_ as e,X as a,Y as i,Z as n,a1 as t,$ as c,a2 as l,C as o}from"./framework-b6ea3384.js";const d={},p={class:"hint-container info"},r=n("p",{class:"hint-container-title"},"源码连续地址",-1),u={href:"https://github.com/lojzes/css_mm_4e",target:"_blank",rel:"noopener noreferrer"},v=l(`<h2 id="定位-position" tabindex="-1"><a class="header-anchor" href="#定位-position" aria-hidden="true">#</a> 定位 position</h2><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">header h1</span> <span class="token punctuation">{</span>
