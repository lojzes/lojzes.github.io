import{_ as a,X as e,Y as t,Z as n,a1 as p,$ as c,a2 as o,C as l}from"./framework-b6ea3384.js";const i="/assets/1-3099d0d2.png",u="/assets/2-3de10dd5.png",k="/assets/3-e3ead6a4.png",r="/assets/4-38babc05.png",d="/assets/5-875db0b1.png",m="/assets/6-4703e8e7.png",v="/assets/7-3e603522.png",b="/assets/8-ad9020fc.png",g={},y={class:"hint-container info"},w=n("p",{class:"hint-container-title"},"参考",-1),C={href:"https://developer.aliyun.com/article/785815",target:"_blank",rel:"noopener noreferrer"},h=o(`<h2 id="线路检查工具" tabindex="-1"><a class="header-anchor" href="#线路检查工具" aria-hidden="true">#</a> 线路检查工具</h2><p>1 意义</p><p>为什么需要线路检查工具呢，有以下几个方面的原因：</p><pre><code>每逢大促都需要进行各网络和各行业的线路调整，调整完成之后，是否得到期望状态，需要检查确认。
...
</code></pre>`,74);function S(f,D){const s=l("ExternalLinkIcon");return e(),t("div",null,[n("div",y,[w,n("p",null,[n("a",C,[p("设计模式在业务系统中的应用"),c(s)])])]),h])}const L=a(g,[["render",S],["__file","apply.html.vue"]]);export{L as default};
