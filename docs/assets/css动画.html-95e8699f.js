import{_ as a,X as e,Y as i,Z as n,a1 as t,$ as p,a2 as c,C as l}from"./framework-b6ea3384.js";const o={},u={class:"hint-container info"},d=n("p",{class:"hint-container-title"},"源码连续地址",-1),r={href:"https://github.com/lojzes/css_mm_4e",target:"_blank",rel:"noopener noreferrer"},v=c(`<h2 id="过度" tabindex="-1"><a class="header-anchor" href="#过度" aria-hidden="true">#</a> 过度</h2><p>//TODO</p><h2 id="动画" tabindex="-1"><a class="header-anchor" href="#动画" aria-hidden="true">#</a> 动画</h2><p>CSS 还提供了一种创建动画的机制，而且功能更丰富。CSS 过渡只能把一系列 CSS 属性从一个状态变到另一个状态。CSS 动画则能把一系列 CSS 属性从一个状态变到另一个状态，再变到第三个状态，然后一直这么变下去。此外，还能重播动画访客把鼠标移到动画上时暂停动画，甚至在动画结束时还能倒播动画。 CSS 动画比过渡复杂一些，不过有个额外的好处:无需触发就能开始播放动画。我们可以在:hover 状态中添加动画，当鼠标移到元素上时开始播放，也可以在加载页面时开始播放动画。访客初次访问网站时，可以使用这种动画效果，把访客的注意力吸引到横幅或徽标上。</p><p>创建动画的过程分成以下两步: 定义动画。 设置关键帧，列出要变化的 CSS 属性 把动画应用到元素上 定义好动画之后，可以把动画应用到页面中任意个元素上。而且，可以分别为每个元素设置时序、延迟和其他动画属性。因此，在页面中可以多次使用设置稍微不同的同一个动画。</p><h3 id="定义动画" tabindex="-1"><a class="header-anchor" href="#定义动画" aria-hidden="true">#</a> 定义动画</h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token comment">/* aniColor 动画名称 */</span>
