import{_ as e,X as s,Y as n,a2 as a}from"./framework-0b23a550.js";const i="/assets/merge-rebase-diff-2f0f1436.png",t={},l=a(`<h2 id="_1-修改已提交的msg" tabindex="-1"><a class="header-anchor" href="#_1-修改已提交的msg" aria-hidden="true">#</a> 1.修改已提交的msg</h2><blockquote><p>git commit --amend 命令</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> commit <span class="token parameter variable">--amend</span> 修改最后一次提交的msg
