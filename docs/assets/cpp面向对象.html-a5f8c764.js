import{_ as a,X as e,Y as t,Z as n,a1 as p,$ as o,a2 as c,C as i}from"./framework-b6ea3384.js";const l="/assets/cpp-6-4ade829d.png",u="/assets/cpp-8-6138fe66.png",d="/assets/cpp-9-a35d5796.png",r={},k={class:"hint-container info"},v=n("p",{class:"hint-container-title"},"参考",-1),m={href:"https://www.runoob.com/cplusplus/cpp-files-streams.html",target:"_blank",rel:"noopener noreferrer"},b=c('<h2 id="类-对象" tabindex="-1"><a class="header-anchor" href="#类-对象" aria-hidden="true">#</a> 类 &amp; 对象</h2><p>C++ 在 C 语言的基础上增加了面向对象编程，C++ 支持面向对象程序设计。类是 C++ 的核心特性，通常被称为用户定义的类型。</p><p>类用于指定对象的形式，是一种用户自定义的数据类型，它是一种封装了数据和函数的组合。类中的数据称为成员变量，函数称为成员函数。类可以被看作是一种模板，可以用来创建具有相同属性和行为的多个对象。</p><h2 id="类定义" tabindex="-1"><a class="header-anchor" href="#类定义" aria-hidden="true">#</a> 类定义</h2><p><img src="'+l+`" alt="" loading="lazy"></p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code>
class Box
