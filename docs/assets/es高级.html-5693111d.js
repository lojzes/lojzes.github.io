import{_ as n,X as s,Y as a,a2 as e}from"./framework-0b23a550.js";const t="/assets/7-96efc1ad.png",p="/assets/8-fca110d7.png",o="/assets/9-5e22c38c.png",i={},c=e('<div class="hint-container tip"><p class="hint-container-title">参考</p></div><h2 id="批量操作" tabindex="-1"><a class="header-anchor" href="#批量操作" aria-hidden="true">#</a> 批量操作</h2><p><img src="'+t+`" alt="" loading="lazy"></p><h2 id="matchall-查询" tabindex="-1"><a class="header-anchor" href="#matchall-查询" aria-hidden="true">#</a> matchAll 查询</h2><h1 id="默认情况下-es一次展示10条" tabindex="-1"><a class="header-anchor" href="#默认情况下-es一次展示10条" aria-hidden="true">#</a> 默认情况下，es一次展示10条</h1><p>GET persons/_search</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
