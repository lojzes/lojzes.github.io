import{_ as n,X as s,Y as i,a2 as a}from"./framework-b6ea3384.js";const e={},t=a(`<div class="hint-container info"><p class="hint-container-title">参考</p></div><h2 id="源码安装" tabindex="-1"><a class="header-anchor" href="#源码安装" aria-hidden="true">#</a> 源码安装</h2><h3 id="下载源码" tabindex="-1"><a class="header-anchor" href="#下载源码" aria-hidden="true">#</a> 下载源码</h3><p>https://nginx.org/download/nginx-1.24.0.tar.gz</p><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><h3 id="配置configure" tabindex="-1"><a class="header-anchor" href="#配置configure" aria-hidden="true">#</a> 配置configure</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 执行 指定安装目录</span>
